        ...
        <div class="card-body">
          <form action="{{URL::to('/user/store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select class="select2-single-placeholder form-control" name="listStatus" id="select2SinglePlaceholder1">
                <option value="">Select</option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
            ...
            <div class="form-group">
              ...
              <div class="custom-file">
                <input type="file" class="custom-file-input" id="customFile" name="imgAvatar">
